 ...
 * escrow tests and the deterministic regression replays under
 * tests/invariants/regression/. The property gate is budgeted separately and
...
module.exports = {
  ...
  spec: override
    ...
    : ["tests/*.ts", "tests/invariants/regression/*.ts"],
};
